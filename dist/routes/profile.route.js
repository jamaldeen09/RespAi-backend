...
// ** Validation helper ** \\
const { editProfileValidation } = new Validation();
// ** Fetches a user's profile ** \\
profileRouter.get("/me", verifyAccessToken, getProfile);
// ** Edits a user's profile *8 \\
profileRouter.patch("/me", verifyAccessToken, rateLimit({
    key: "user",
    limit: 30,
    windowMs: 60000
}), editProfileValidation(), expressValidationHandler, editProfile);
